    ...
    def draw_tubes(self):
        for i, tube in enumerate(tubes):
            frame = ctk.CTkFrame(self, width=90, height=355,
                                border_color="black", border_width=3,fg_color="skyblue",bg_color="skyblue", corner_radius=50)
    ...
    def reset_highlight(self):
        for i, frame in enumerate(self.tube_frames):
            ...
            for j, widget in enumerate(frame.winfo_children()):
                ...
                frame.configure(border_color="black",bg_color="skyblue")  # Reset to original color 
